...
const duration = document.querySelector('.duration-container')

video.addEventListener("loadeddata",() =>{
    totalTime.textContent = fromatDuration(video.duration);

})

video.addEventListener("timeupdate",() =>{
    currentTime.textContent = fromatDuration(video.currentTime)
